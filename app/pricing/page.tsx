...
export default function PricingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">Simple, Transparent Pricing</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Free</h2>
          ...
          {/* Team Plan */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border-2 border-blue-600 dark:border-blue-500">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Team</h2>
              <p className="text-gray-600 dark:text-gray-300">For companies & teams</p>
              <div className="mt-4">
        ...
        <div className="max-w-3xl mx-auto mt-20">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-semibold mb-2 text-gray-900 dark:text-white">Can I switch plans later?</h3>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">We accept all major credit cards and PayPal. All payments are processed securely through Stripe.</p>
            </div>
            <div>
              <h3 className="font-semibold mb-2 text-gray-900 dark:text-white">Is there a refund policy?</h3>
              <p className="text-gray-600 dark:text-gray-300">Yes, we offer a 14-day money-back guarantee if you're not satisfied with our service.</p>
            </div>
            <div>
              <h3 className="font-semibold mb-2 text-gray-900 dark:text-white">How does the Team plan work?</h3>
              <p className="text-gray-600 dark:text-gray-300">The Team plan allows you to add up to 5 team members, each with their own Premium features. Contact our sales team for custom team sizes or enterprise solutions.</p>
            </div>
          </div>
        </div>
      </div>
